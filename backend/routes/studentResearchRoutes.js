...
const { saveResearchPaper, getMyResearchPapers, getStudentResearch , getAllResearchPapers } = require("../controllers/studentResearchController");
...
router.get("/", authMiddleware, checkRole("teacher", "admin"), getAllResearchPapers);
